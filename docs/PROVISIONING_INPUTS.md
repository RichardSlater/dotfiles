...
| Oxlint | `v1.81.0` | [Official Oxc GitHub release](https://github.com/oxc-project/oxc/releases/tag/apps_v1.81.0) | GitHub release-asset SHA-256 values verified by Ansible `get_url` before extraction and installation | Linux GNU `x86_64` (`d176d586ff131466383c70ce655afee7dc5a0f0e8fcbdebc8e1320021431e69c`) and `aarch64` (`e80f0a157a6ebbba332848a19f93f2fe593c42bc69d51d316446ada1ae47abc8`) only; all other architectures fail before download |
