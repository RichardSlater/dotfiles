...
| Podman network-helper compatibility set | Podman `v6.0.2`, Netavark `v2.0.0`, Aardvark-DNS `v2.0.0` | [Netavark v2.0.0 release](https://github.com/containers/netavark/releases/tag/v2.0.0) and [Aardvark-DNS v2.0.0 release](https://github.com/containers/aardvark-dns/releases/tag/v2.0.0) | Netavark explicitly requires Podman 6.0 and says the versions must be updated together; Aardvark-DNS uses the matching `2.0` major-minor version. | This reviewed artifact pair is Linux `x86_64` only. Unsupported architectures fail before download. |
| Netavark helper | `netavark.gz` from `v2.0.0` | [Official immutable release asset](https://github.com/containers/netavark/releases/download/v2.0.0/netavark.gz) | Publisher SHA-256 `d8bc342c38382029e7e12256120ac0f7676dcc063aa1e7259189bb69cc869563`, verified before decompression and installation | Linux `x86_64` only |
| Aardvark-DNS helper | `aardvark-dns.gz` from `v2.0.0` | [Official immutable release asset](https://github.com/containers/aardvark-dns/releases/download/v2.0.0/aardvark-dns.gz) | Publisher SHA-256 `fdaa3665ce58337fe597e0822e24de97528529d1a39fa6b655aa656c8ad33086`, verified before decompression and installation | Linux `x86_64` only |
